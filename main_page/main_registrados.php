...
<body>
    <div class="container">
        ...
        <div class="main-content">
            <a href="/Tetris-front/leaderboard_page/leaderboard.php">
            ...
            <div class="content">
                <a href="/Tetris-front/tetramin/index.html">
                    <button class="mode">Clasico</button>
                </a>
                <a href="#">
                    <button class="mode">Carrera</button>
                </a>
                <a href="#">
                    <button class="mode">Excavar</button>
                </a>
                <a href="#">
                    <button class="mode">Chill-Out</button>
                </a>
                <a href="/Tetris-front/g.confi_page/config.html">
                    <button class="mode">Configuraciones</button>
                </a>
            </div>
        </div>
        <footer>
